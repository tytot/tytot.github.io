const entries = [
    {
        ...
        "starred": false,
        "description": "A system that enables customizable proximity voice chat in a Minecraft server. The framework consists of a Node.js data RESTful API, a Java Bukkit plugin that pushes proximity data from the server to the API, and an executeable Windows Presentation Foundation GUI made with C# that reads from the API.",
        "links": {
            "github": "https://github.com/tytot/minecraft-proximity-discord-chat"
        } ,
        "tags": "C#, Java, JavaScript, Node.js, Express.js, Heroku, Bukkit, WPF, Minecraft, Discord",
        "image": "proximity.png"
    },
    {
        "name": "The Puzzled Cube",
        "starred": false,
        "description": "A LITTY puzzle platformer game programmed in Java Swing. The Puzzled Cube includes 24 challenging levels featuring 4 unique powerups, seamless graphics, and immersive audio. It's a true brain-teaser!",
        "links": {
            "github": "https://github.com/tytot/fbla-2021"
        } ,
        "tags": "Java, Java Swing, Theseus",
        "image": "tpc.png"
    },
    {
        "name": "Medical Record Blockchain",
        "starred": true,
        "description": "A proof-of-concept Hyperledger Fabric distributed ledger for medical records. Powered by a Java smart contract, the blockchain stores patient medication and immunization data and authenticates with certificate authorities. Users manage records through a Bootstrap web application that communicates with a custom Express.js API.",
        "links": {
    ...
    },
    {
        ...
        "starred": true,
        "description": "A Google Chrome extension that allows teachers to easily take attendance for their virtual classes. It automatically tracks when students join and leave and how long they are present. Teachers may view this data through the extension UI, or export it to a Google Spreadsheet via the Google Sheets API. Won Grand Prize at the 2020 HackDefy Hackathon.",
        "links": {
    ...
    },
    {
        "name": "Pool",
        "starred": false,
        "description": "A fully-functional pool simulation made in Java Swing. Game modes include 8-ball, 9-ball, and 10-ball. The game features score-keeping, accurate collision detection and physics, and aim guidance. Inspiration for certain aspects came from Game Pigeon's 8-ball.",
        "links": {
            "github": "https://github.com/tytot/pool"
        },
        "tags": "Java, Java Swing, pool, physics",
        "image": "pool.png"
    },
    {
        "name": "Needle Exchange Program Mediator",
        "starred": true,
        "description": "My internship project for the Johns Hopkins Applied Physics Lab. It connects various health services, including OpenHIM, OpenInfoMan, and RapidPro together to track the status of a needle exchange program. A custom-made human resource information system (HRIS) serves as the main point of interaction. The project aims to promote interoperability and efficent workflow.",
        "links": {
    ...
    },
    {
        "name": "tylerl.in",
        "starred": false,
        "description": "This website! Made to improve my website creation skills and because the url is litty, it features an 'about' section, a portfolio, and an 'extras' section. Portfolio entries are dynamically generated using a local JSON file. There are a couple of hidden easter eggs; can you find them?",
        "links": {
            "github": "https://github.com/tytot/tytot.github.io"
        },
        "tags": "HTML, CSS, JavaScript, JQuery, website design",
        "image": "website.png"
    },
    {
        "name": "Chinese Checkers",
        "starred": false,
        "description": "A faithful recreation of Chinese Checkers made from scratch in Java. Up to 6 players can play. The game features optional CPUs and variable screen sizes.",
        "links": {
            "github": "https://github.com/tytot/chinese-checkers"
        },
        "tags": "Java, chinese checkers",
        "image": "chinese-checkers.png"
    },
    {
        "name": "Making a Monster",
        "starred": true,
        "description": "A website that depicts the events of Mary Shelley's <i>Frankenstein</i> through Chapters 11 and 12. The story is portrayed from Frankenstein's point of view using slideshow visuals and text. Won the 2017 Maryland Society of Educational Technology Award for Multimedia.",
        "links": {

const entries = [
    ...
    },
    {
        ...
        starred: false,
        description:
            "A LITTY puzzle platformer game programmed in Java Swing. The Puzzled Cube includes 24 challenging levels featuring 4 unique powerups, seamless graphics, and immersive audio. It's a true brain-teaser!",
        links: {
    ...
    },
    {
        ...
        starred: true,
        description:
            'An almost-limitless arcade game made in Unity 3D for iOS. Players control a physics-defying bubble with the goal of sinking as deep in the ocean as possible. The game includes 15 different sea creatures, power-ups, achievements, and leaderboards. Scripted using C#.',
        links: {

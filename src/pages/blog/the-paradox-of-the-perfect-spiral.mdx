...
In order to visualize our equations, we must decide upon values for $\Omega$ and $\omega_p$. To this end, we turn to wind-tunnel aerodynamic tests of the motion of a football conducted by William J. Rae [(Rae)](#bib-rae), in which he determined that for a spiral pass with a launch angle of $30^{\circ}$ and a launch speed of $27.4$ m/s,
...
<ol className="bib">
    ...
    <li id="bib-rae" className="bib-entry">
